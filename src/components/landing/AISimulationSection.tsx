...
//                         <div className="inline-flex items-center gap-3 px-4 py-1.5 bg-teal-50 border border-teal-100 rounded-full text-[10px] font-black text-[#0D9488] uppercase tracking-[0.25em] mb-6 lg:mb-8">
//                             <BarChart3 size={14} />
//                             Precision Analytics
//                         </div>
//                         <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-[#0F766E] leading-[1.1] mb-6 lg:mb-8 tracking-tighter px-2 lg:px-0">
//                             AI That Doesn't Just <br className="hidden sm:block" />
//                             Check Answers — <br className="hidden sm:block" />
//                             <span className="text-[#0D9488]">It Improves Scores.</span>
//                         </h2>
...
//                                     <div className="text-sm font-black text-[#0F766E] mb-1 lg:mb-2 flex items-center gap-2">
...
//                             <button className="px-8 lg:px-10 py-4 bg-[#0D9488] text-white rounded-2xl font-black text-sm uppercase tracking-widest shadow-2xl shadow-teal-500/30 hover:bg-teal-700 transition-all active:scale-95 w-full sm:w-auto">
//                                 Explore Analytics
//                             </button>
//                             <button className="px-8 lg:px-10 py-4 bg-white text-[#0D9488] border-2 border-[#0D9488] rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-teal-50 transition-all active:scale-95 w-full sm:w-auto">
//                                 View Sample Report
//                             </button>
//                         </div>
//                     </div>
...
//                         <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[110%] lg:w-[120%] h-[110%] lg:h-[120%] bg-teal-100/40 rounded-full blur-[80px] lg:blur-[120px] -z-10"></div>
...
//                                 <h3 className="text-xl lg:text-2xl font-black text-[#0F766E] tracking-tighter">Performance Audit</h3>
...
//                                         <p className="text-2xl lg:text-3xl font-black text-[#0F766E]">482 <span className="text-base lg:text-lg text-slate-300">/ 720</span></p>
//                                     </div>
//                                     <div className="h-3 lg:h-4 bg-white rounded-full p-1 shadow-inner border border-slate-200">
//                                         <div className="h-full bg-gradient-to-r from-teal-400 to-[#0D9488] rounded-full shadow-lg" style={{ width: '68%' }}></div>
//                                     </div>
//                                 </div>

//                                 <div className="grid grid-cols-2 gap-6 lg:gap-10">
//                                     {[
//                                         { label: "Accuracy", val: "68%", color: "bg-teal-500" },
//                                         { label: "Time Eff.", val: "91%", color: "bg-[#0F766E]" }
//                                     ].map((m, i) => (
//                                         <div key={i}>
...
//                         {/* Floating Micro-UI */}
//                         <div className="absolute -bottom-4 -left-2 lg:-bottom-6 lg:-left-12 bg-[#0F766E] rounded-2xl lg:rounded-3xl p-4 lg:p-8 shadow-2xl text-white z-20 max-w-[160px] lg:max-w-[220px] transition-transform hover:scale-110 duration-500">
//                             <PieChartIcon size={20} className="lg:size-6 text-teal-300 mb-3 lg:mb-4" />
...
//                         Simulation That <span className="text-[#0D9488]">Wins Exams.</span>
//                     </h2>
...
//                             <div className="w-20 h-20 lg:w-24 lg:h-24 bg-white rounded-2xl lg:rounded-3xl flex items-center justify-center text-[#0F766E] mx-auto mb-8 lg:mb-10 shadow-xl border border-slate-50 group-hover:bg-[#0D9488] group-hover:text-white transition-all duration-300 group-hover:-translate-y-2">
//                                 {s.icon}
//                             </div>
//                             <h3 className="text-lg lg:text-xl font-black text-[#0F766E] mb-3 lg:mb-4 tracking-tight">{s.title}</h3>
...
//                 <div className="bg-[#0F766E] rounded-[2.5rem] p-8 md:p-12 text-white relative overflow-hidden">
...
//                                 <button className="px-8 py-3 bg-[#0D9488] text-white rounded-xl font-bold hover:bg-teal-600 transition-all">Try Demo Test (Free)</button>
...
//                                         {item.icon}
//                                     </div>
//                                     <p className="text-xs font-bold text-teal-100 max-w-[80px]">{item.label}</p>
//                                 </div>
//                             ))}
//                         </div>
//                     </div>
//                     {/* Decorative Background */}
//                     <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-teal-500/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3"></div>
//                 </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-14">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-5">
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              <button className="px-5 py-2.5 bg-teal-600 text-white rounded-lg text-sm font-semibold hover:bg-teal-700">
                Explore Analytics
              </button>
              <button className="px-5 py-2.5 text-teal-600 rounded-lg text-sm font-semibold hover:bg-teal-50">
                View Sample Report
              </button>
            </div>
          </div>
        ...
        <div className="bg-teal-600 rounded-xl p-6 text-white grid md:grid-cols-2 gap-6 items-center">
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              <button className="px-4 py-2 bg-white text-teal-600 rounded-md text-sm font-semibold">
                Try Demo Test (Free)
              </button>
