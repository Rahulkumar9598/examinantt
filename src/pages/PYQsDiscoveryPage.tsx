    ...
    return (
        <PageLayout>
            <div className="bg-[#0A0A0A] min-h-screen text-white overflow-hidden relative">
                {/* Background Blobs */}
                <div className="absolute top-0 left-1/4 w-96 h-96 bg-teal-600/10 rounded-full blur-[120px] pointer-events-none"></div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
                    ...
                    >
                        <h1 className="text-5xl md:text-6xl font-black mb-6 tracking-tight">
                            Master Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-indigo-400">Past Exams</span>
                        </h1>
                    ...
                    >
                        <div className="absolute -inset-1 bg-gradient-to-r from-teal-600 to-indigo-600 rounded-2xl blur opacity-20 group-hover:opacity-40 transition duration-300"></div>
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-14 pr-6 py-5 bg-zinc-900/80 backdrop-blur-xl border border-white/10 rounded-2xl text-white placeholder:text-zinc-500 focus:outline-none focus:ring-2 focus:ring-teal-500/50 transition-all font-medium text-lg shadow-2xl"
                            />
                        </div>
                    </motion.div>
                    ...
                    {isLoading ? (
                        ...
                        >
                            {filteredPyqs.map((pyq) => (
                                ...
                                >
                                    <div className="absolute inset-0 bg-gradient-to-br from-teal-500/5 to-transparent rounded-[32px] opacity-0 group-hover:opacity-100 transition-opacity"></div>
                                    
                                    <div className="flex justify-between items-start mb-8 relative z-10">
                                        <div className={`p-4 rounded-2xl ${pyq.type === 'test' ? 'bg-indigo-500/10 text-indigo-400' : 'bg-teal-500/10 text-teal-400'} border border-white/5`}>
                                    ...
                                    <h3 className="text-2xl font-bold text-white mb-3 tracking-tight group-hover:text-teal-400 transition-colors relative z-10">{pyq.title}</h3>
                                    
                                    <div className="flex items-center gap-3 mb-8 relative z-10">
                                        <span className="py-1 px-3 bg-teal-600/20 text-teal-400 rounded-lg text-sm font-bold border border-teal-500/20">{pyq.year}</span>
